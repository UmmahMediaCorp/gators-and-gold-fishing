...
export const imagery = {
  ...
  // Newly pulled real photography (round 2)
  iceWalleyeTrophy: "/images/ice-walleye-trophy.jpg",
  iceWalleyeBlizzard: "/images/ice-walleye-blizzard.jpg",
  cfmotoUTV: "/images/cfmoto-utv.jpg",
  twoMenSummerWalleye: "/images/two-men-summer-walleye.jpg",
  familyIceWalleye: "/images/family-ice-walleye.jpg",
  hukWalleye: "/images/huk-walleye.jpg",
  camoWalleye: "/images/camo-walleye.jpg",
  camoPike: "/images/camo-pike.jpg",
  polarizedWalleye: "/images/polarized-walleye.jpg",
  yamahaPike: "/images/yamaha-pike.jpg",
  womanTrophyPike: "/images/woman-trophy-pike.jpg",
  topoLight: "/images/topo-map-light.jpg",
  // ── AI-generated atmospheric + action imagery ──
  ...
  // Round 2 generated — action + lifestyle
  underwaterWalleye: "/images/underwater-walleye.jpg",
  pikeStrike: "/images/pike-strike-action.jpg",
  dockFirstLight: "/images/dock-first-light.jpg",
  shoreLunch: "/images/shore-lunch-campfire.jpg",
};
...
export const trophyReel = [
  ...
  { src: imagery.womanTrophyPike,     species: "Northern Pike", size: "Class 40\"+",  location: "Lac La Biche" },
  { src: imagery.iceWalleyeTrophy,    species: "Walleye",       size: "Hard Water",   location: "Lac La Biche" },
  { src: imagery.pikeYellow,          species: "Northern Pike", size: "44\"",          location: "Pinehurst Lake" },
  { src: imagery.familyIceWalleye,    species: "Walleye",       size: "Family Trip",  location: "Lac La Biche · Ice" },
  ...
  { src: imagery.hukWalleye,          species: "Walleye",       size: "Class",        location: "Lac La Biche" },
  { src: imagery.iceWalleyeBlizzard,  species: "Walleye",       size: "Snow Day",     location: "Lac La Biche · Ice" },
  { src: imagery.yamahaPike,          species: "Northern Pike", size: "Trophy",       location: "Lac La Biche" },
  ...
  { src: imagery.polarizedWalleye,    species: "Walleye",       size: "Summer",       location: "Lac La Biche" },
  ...
  { src: imagery.camoWalleye,         species: "Walleye",       size: "Trophy",       location: "Lac La Biche" },
];
...
export const galleryImages = [
  ...
  { src: imagery.womanTrophyPike,     alt: "Trophy northern pike on Lac La Biche",    tag: "Trophy Pike" },
  { src: imagery.iceWalleyeTrophy,    alt: "Trophy ice walleye, gold scales",         tag: "Ice Fishing" },
  { src: imagery.pikeYellow,          alt: "Massive northern pike, yellow jacket",    tag: "Trophy Pike" },
  { src: imagery.familyIceWalleye,    alt: "Family with walleye on the ice",          tag: "Tradition"   },
  ...
  { src: imagery.cfmotoUTV,           alt: "CFMOTO UTV on the lake ice",              tag: "Ice Fishing" },
  ...
  { src: imagery.iceWalleyeBlizzard,  alt: "Ice walleye on a snowy day",              tag: "Ice Fishing" },
  { src: imagery.walleyeCloudy,       alt: "Walleye, overcast morning",               tag: "Walleye"     },
  { src: imagery.hukWalleye,          alt: "Class walleye, summer morning",           tag: "Walleye"     },
  { src: imagery.pikeTreeline,        alt: "Trophy pike, Lakeland treeline",          tag: "Trophy Pike" },
  { src: imagery.twoMenSummerWalleye, alt: "Two anglers with summer walleye",         tag: "Tradition"   },
  ...
  { src: imagery.dockFirstLight,      alt: "Boat tied at the dock at first light",    tag: "Open Water"  },
  { src: imagery.pikeCamo,            alt: "Pike landed in green jacket",             tag: "Trophy Pike" },
  { src: imagery.yamahaPike,          alt: "Trophy pike on a Yamaha-power boat",      tag: "Trophy Pike" },
  { src: imagery.pikeGreen,           alt: "Pike on a clear morning",                 tag: "Trophy Pike" },
  { src: imagery.camoPike,            alt: "Bass Pro angler with northern pike",      tag: "Trophy Pike" },
  { src: imagery.camoWalleye,         alt: "Bass Pro angler with walleye",            tag: "Walleye"     },
  { src: imagery.polarizedWalleye,    alt: "Walleye landed under polarized sky",      tag: "Walleye"     },
  { src: imagery.rodBentSunset,       alt: "Rod bent at sunset",                      tag: "Open Water"  },
  { src: imagery.pikeStrike,          alt: "Pike strike at the boat side",            tag: "Action"      },
  { src: imagery.underwaterWalleye,   alt: "Underwater view of a walleye",            tag: "Action"      },
  { src: imagery.shoreLunch,          alt: "Shore lunch over the campfire",           tag: "Lifestyle"   },
